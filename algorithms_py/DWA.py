...
Repository: PythonRobotics (23.7k+ Stars)
License: MIT
"""
import math
...
def dwa_control(state, config, goal, ob):
    """
    ...
    # 代入当前状态、动态窗口 得到 预测 后点的坐标 、预测的轨迹
    predict_pos, trajectory = calc_control_and_trajectory(state, dw, config, goal, ob)
    return predict_pos, trajectory
